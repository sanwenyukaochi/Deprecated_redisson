...
import com.vinsguru.redisson.test_reactive.assignment.Category;
import com.vinsguru.redisson.test_reactive.assignment.PriorityQueue;
import com.vinsguru.redisson.test_reactive.assignment.UserOrder;
...
public class Lec16PriorityQueueTest extends BaseTest {
    ...
    public void setupQueue(){
        RScoredSortedSetReactive<UserOrder> sortedSet = this.client.getScoredSortedSet("user:order:queue", new TypedJsonJackson3Codec(UserOrder.class));
