...
public class Lec01KeyValueTest extends BaseTest {
    ...
    public void keyValueExpiryTest() {
        redissonClient.<String>getBucket("user:1:name", StringCodec.INSTANCE).set("sam", Duration.ofSeconds(10));
        redissonClient.<String>getBucket("user:1:name", StringCodec.INSTANCE).get();
    }
    ...
    public void keyValueExtendExpiryTest() {
        ...
        //extend
        sleep(1000);
        RBucket<String> bucket = redissonClient.getBucket("user:1:name", StringCodec.INSTANCE);
